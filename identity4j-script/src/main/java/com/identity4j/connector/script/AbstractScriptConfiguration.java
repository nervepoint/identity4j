...
public abstract class AbstractScriptConfiguration extends AbstractConnectorConfiguration {
	...
	public AbstractScriptConfiguration(MultiMap configurationParameters) {
