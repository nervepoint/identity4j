...
public class ActiveDirectoryConnector extends AbstractDirectoryConnector<ActiveDirectoryConfiguration> {
	 ...
	 */
	private static final Collection<String> DEFAULT_USER_ATTRIBUTES = Collections.unmodifiableList(Arrays
	 ...
	 * well.
	 */
	private static final Collection<String> ATTRIBUTES_TO_EXCLUDE_FROM_UPDATE = Collections.unmodifiableList(Arrays
	 ...
	 * well.
	 */
	private static final Collection<String> ALL_USER_ATTRIBUTES = Collections.unmodifiableList(Arrays.asList(new String[] { SAM_ACCOUNT_NAME_ATTRIBUTE,
	...
	private static final Collection<String> CORE_IDENTITY_ATTRIBUTES = Collections.unmodifiableList(Arrays.asList(new String[] { COMMON_NAME_ATTRIBUTE,
			SAM_ACCOUNT_NAME_ATTRIBUTE, USER_PRINCIPAL_NAME_ATTRIBUTE, OBJECT_CLASS_ATTRIBUTE, HIGHEST_COMMITTED_USN }));

	private static final Collection<String> ALL_ROLE_ATTRIBUTES = Collections.unmodifiableList(Arrays.asList(
