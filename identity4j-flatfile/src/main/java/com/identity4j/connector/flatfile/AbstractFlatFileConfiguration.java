...
public abstract class AbstractFlatFileConfiguration extends AbstractVFSConfiguration {
    ...
    public AbstractFlatFileConfiguration(MultiMap configurationParameters) {
